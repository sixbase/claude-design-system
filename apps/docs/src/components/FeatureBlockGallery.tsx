...
export function FeatureBlockDefault() {
  return (
    <FeatureBlock
      ...
      image={<img src={makePlaceholder('Feature', '#C8C1B6', '#4E473D')} alt="Feature image" className="ds-demo-cover-image" />}
    />
  );
}
...
export function FeatureBlockReverse() {
  return (
    <FeatureBlock
      ...
      image={<img src={makePlaceholder('Reversed', '#B3AC9F', '#413A31')} alt="Reversed feature image" className="ds-demo-cover-image" />}
    />
  );
}
